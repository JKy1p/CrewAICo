...
class Agent(BaseModel):
    ...
    # The above code appears to be a comment section in a Python script. Comments in Python start with
    # the `#` symbol and are used to provide explanations or notes about the code. In this case, the
    # comment section is labeled as "tools" and "
